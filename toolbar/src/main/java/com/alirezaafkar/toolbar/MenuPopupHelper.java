...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
                           boolean overflowOnly, int popupStyleAttr, int direction) {
        this(context, menu, anchorView, overflowOnly, popupStyleAttr, 0, direction);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
                           boolean overflowOnly, int popupStyleAttr, int popupStyleRes, int direction) {
