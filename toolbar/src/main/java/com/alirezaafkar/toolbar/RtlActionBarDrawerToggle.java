 ...
 * <p/>
 * <p>To use <code>RtlActionBarDrawerToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 * <p/>
 * <p><code>RtlActionBarDrawerToggle</code> can be used directly as a
...
public class RtlActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    /**
     * Allows an implementing Activity to return an {@link RtlActionBarDrawerToggle.Delegate} to use
     ...
     * may have diverged in such a way that the RtlActionBarDrawerToggle was not notified.
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("RtlActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon"
